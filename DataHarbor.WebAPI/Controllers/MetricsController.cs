...
namespace DataHarbor.WebAPI.Controllers
{
    ...
    public class MetricsController : ControllerBase
    {
        ...
        public MetricsController(IHttpClientFactory httpClientFactory, IPublishEndpoint publishEndpoint)
        {
        ...
        public async Task<IActionResult> GenerateMetrics()
        {
            ...
            var baseUrl = "http://dataharbor-api"; // Base URL of your service
            var endpoints = new[]
            {
                "/api/accounts/all",
